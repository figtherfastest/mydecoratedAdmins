...
<script>
  ...
  export default class Index extends Vue {
    ...
    @tourismManagementDepartmentModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'tourismManagementDepartment', params })
    }

    add () {
      this.$router.push({ name: 'tourismManagementDepartment', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
