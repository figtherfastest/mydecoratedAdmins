<!--旅游目的地 http://localhost/element-seed/data/opinions/index-->
<template>
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="目的地类别" prop="destinationCategory" sortable="custom"/>
        <el-table-column label="所属地区" prop="areaName" sortable="custom"/>
        <el-table-column label="荣誉称号" prop="titleOfHonor" sortable="custom"/>
