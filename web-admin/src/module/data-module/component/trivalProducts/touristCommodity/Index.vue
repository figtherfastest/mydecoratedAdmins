  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="商品类型" prop="type" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    @touristCommodityModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'touristCommodity', params })
    }

    add () {
      this.$router.push({ name: 'touristCommodity', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
