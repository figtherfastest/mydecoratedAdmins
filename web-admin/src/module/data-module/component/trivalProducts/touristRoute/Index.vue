  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="线路名称" prop="name" sortable="custom"/>
        <el-table-column label="线路类型" prop="type" sortable="custom"/>
        <el-table-column label="目的地" prop="target" sortable="custom"/>
        <el-table-column label="线路天数" prop="days" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    @touristRouteModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'touristRoute', params })
    }

    add () {
      this.$router.push({ name: 'touristRoute', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
