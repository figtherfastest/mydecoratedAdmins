<template>
  <div class="videoResource img">
    <el-container>
      <el-header>
        <div class="tittle">视频</div>
        <el-button type="primary" size="mini" @click="openDialog" v-if="!disabled">添加视频</el-button>
      </el-header>
      <el-main>
        <div class="mainWap">
    ...
    <el-dialog title="资源上传" v-if="dialogVisible" :visible.sync="dialogVisible">
      <el-form label-width="100px"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="视频标题" prop="id">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="视频规格" prop="videoSpecifications">
              <el-input v-model="data.videoSpecifications"/>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="视频格式" prop="videoFormat">
              <el-input v-model="data.videoFormat"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="视频时长" prop="theVideoTime">
              <el-input v-model="data.theVideoTime"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
  ...
  export default class videoResource extends Vue {
    /**
