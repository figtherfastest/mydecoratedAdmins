<template>
  <div class="virtualMaterial img">
    <el-container>
      <el-header>
      <div class="tittle">虚拟材料</div>
      <el-button type="primary" size="mini" @click="openDialog" v-if="!disabled">添加虚拟材料</el-button>
    </el-header>
      <el-main>
        <div class="mainWap">
          <el-row class="imgWap" v-for="(fileItem,index) in value" :key="index">
            <el-col :span="22"><div class="grid-content">{{ fileItem.name }}</div></el-col>
            <el-col :span="2" @click="remove(index)"><div class="grid-del "><i class="el-icon-delete"/></div></el-col>
          </el-row>
    ...
    <el-dialog title="资源上传" v-if="dialogVisible" :visible.sync="dialogVisible">
      <el-form label-width="100px"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="素材标题" prop="materialTitle">
              <el-input v-model="data.materialTitle"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="素材分类" prop="theMaterialClassification">
              <el-input v-model="data.theMaterialClassification"/>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
  ...
  const imageModule = namespace('data/virtualMaterial')
  ...
  export default class virtualMaterial extends Vue {
    activeName = '1'
    /**
