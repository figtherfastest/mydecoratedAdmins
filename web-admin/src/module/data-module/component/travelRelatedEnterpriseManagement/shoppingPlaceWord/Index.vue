...
<script>
  ...
  const shoppingPlaceWordModule = namespace('data/shoppingPlaceWord')
  ...
  export default class Index extends Vue {
    ...
    regions
    @shoppingPlaceWordModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'shoppingPlaceWord', params })
    }

    add () {
      this.$router.push({ name: 'shoppingPlaceWord', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
