            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="档次" prop="theGradeOf">
                  <!--<el-input v-model="data.theGradeOf" :disabled="readonly"/>-->
                  <el-select v-model="data.theGradeOf" placeholder="等级">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="餐馆Logo" prop="theRestaurantLogo">
                  <el-input v-model="data.theRestaurantLogo" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="推荐菜" prop="recommendedDishes">
                  <el-input v-model="data.recommendedDishes" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="荣誉资质" prop="honoraryCertificate">
                  <el-input v-model="data.honoraryCertificate" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="统一社会信用代码" label-width="140px" prop="unifiedSocialCreditCode">
                  <el-input v-model="data.unifiedSocialCreditCode" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="法人代表" prop="legalRepresentative">
                  <el-input v-model="data.legalRepresentative" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="连锁经营情况" prop="chainOperationSituation">
                  <el-input v-model="data.chainOperationSituation" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="品牌" prop="brand">
                  <el-input v-model="data.brand" :disabled="readonly" maxlength="50"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="管理公司名称" prop="managementOfTheCompanyName">
                  <el-input v-model="data.managementOfTheCompanyName" :disabled="readonly" maxlength="50"/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-tab-pane>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="预定电话" prop="dueToThePhone">
                  <el-input v-model="data.dueToThePhone" :disabled="readonly" maxlength="20"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="同时就餐人数" prop="atTheSameTimeRepastNumber">
                  <el-input v-model="data.atTheSameTimeRepastNumber" :disabled="readonly" maxlength="20"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="包间数" prop="numberOfRooms">
                  <el-input v-model="data.numberOfRooms" :disabled="readonly" maxlength="20"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="特色菜品" prop="dishesWith">
                  <el-input v-model="data.dishesWith" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="停车场" prop="theParkingLot">
                  ...
                  <el-select v-model="data.theParkingLot" placeholder="停车场">
                    <el-option v-for="item in theParkingLots"
                               :key="item.value"
                               :label="item.label"
                               :value="item.value"/>
                  </el-select>
...
<script>
  ...
  const diningPlaceModule = namespace('data/diningPlace')
  ...
  export default class DiningPlace extends Vue {
    @Prop({ default: () => 'new' })
    id
    modeOfTransports = [{
      value: '旅游专线',
    ...
    @diningPlaceModule.Action('save')
    saveData

    @diningPlaceModule.Action('get')
    getData

    @diningPlaceModule.Action('update')
    updateData
    // 区划下拉选的属性配置
    areaProps = {
      children: 'children',
