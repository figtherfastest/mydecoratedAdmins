...
<script>
  ...
  const automobileServiceModule = namespace('data/automobileService')
  ...
  export default class AutomobileService extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 注册日期
        ...
        industrialAndCommercialRegistrationName: [{
          validator: myrules.validatLength,
          maxlength: 200,
          msg: '长度不能超过200',
          trigger: 'blur'
...
// 电子邮件
    ...
    @automobileServiceModule.Action('save')
    saveData

    @automobileServiceModule.Action('get')
    getData

    @automobileServiceModule.Action('update')
    updateData
// 区划下拉选的属性配置
    areaProps = {
      children: 'children',
