  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="所属区域" prop="areaName" sortable="custom"/>
...
// 区划下拉选的属性配置
    ...
    regions
    edit (params) {
      this.$router.push({ name: 'parkingLot', params })
    }

    add () {
      this.$router.push({ name: 'parkingLot', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
