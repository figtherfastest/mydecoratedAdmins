...
<script>
  ...
  export default class Index extends Vue {
    ...
    data = {}
    inputVal = ''
    @touristInformationCenterModule.State('url')
    ajax
    areaProps = {
      children: 'children',
      label: 'name',
    ...
    regions
    edit (params) {
      this.$router.push({ name: 'touristInformationCenter', params })
    }

    add () {
      this.$router.push({ name: 'touristInformationCenter', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
