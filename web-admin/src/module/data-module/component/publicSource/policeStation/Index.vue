  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="派出所全称" prop="fullname" sortable="custom"/>
        <el-table-column label="所在区域" prop="areaName" sortable="custom"/>
        <el-table-column label="地址" prop="address" sortable="custom"/>
        <el-table-column label="派出所级别" prop="policeStationGrade" sortable="custom"/>
        <el-table-column label="报警电话" prop="policeStationPhone" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    regions
    edit (params) {
      this.$router.push({ name: 'policeStation', params })
    }

    add () {
      this.$router.push({ name: 'policeStation', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
