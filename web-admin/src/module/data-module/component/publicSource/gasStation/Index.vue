...
<script>
  ...
  const gasStationModule = namespace('data/gasStation')
  @Component({
    components: {
      EleDataTables
    }
  ...
  export default class Index extends Vue {
    ...
    @gasStationModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'gasStation', params })
    }

    add () {
      this.$router.push({ name: 'gasStation', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
