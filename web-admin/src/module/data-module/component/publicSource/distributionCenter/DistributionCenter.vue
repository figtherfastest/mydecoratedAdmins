      ...
      <el-form label-width="100px"
        ...
        <el-tabs>
          <el-tab-pane label="基本信息">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="设施设备" prop="equipment">
                  <el-input v-model="data.equipment" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="隶属企业" prop="affiliatedEnterprise">
                  <el-input v-model="data.affiliatedEnterprise" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="主要开通城市" prop="openingCity">
                  <el-input v-model="data.openingCity" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
...
<script>
  ...
  const distributionCenterModule = namespace('data/distributionCenter')
...
// 区划下拉选的属性配置
    ...
    @distributionCenterModule.Action('save')
    saveData

    @distributionCenterModule.Action('get')
    getData

    @distributionCenterModule.Action('update')
    updateData
