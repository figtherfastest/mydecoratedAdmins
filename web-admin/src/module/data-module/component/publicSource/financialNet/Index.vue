  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="所属银行" prop="bank" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    data = {}
    inputVal = ''
    @financialNetModule.State('url')
    ajax
    @regionModule.Getter('regions')
    regions
    edit (params) {
      this.$router.push({ name: 'financialNet', params })
    }

    add () {
      this.$router.push({ name: 'financialNet', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
