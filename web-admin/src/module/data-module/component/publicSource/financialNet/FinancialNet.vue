      ...
      <el-form label-width="100px"
        ...
        <el-tabs>
          <el-tab-pane label="金融网点信息">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="交通方式" prop="transportation">
                  <el-input v-model="data.transportation" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="交通描述" prop="transportDescription">
                  <el-input v-model="data.transportDescription" :disabled="readonly"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="所属银行" prop="bank">
                  <el-input v-model="data.bank" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="联系方式" prop="contactInformation">
                  <el-input v-model="data.contactInformation" :disabled="readonly" maxlength="20"/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-tab-pane>
...
<script>
  ...
  const financialNetModule = namespace('data/financialNet')
  const regionModule = namespace('data/region')
  @Component({
    components: {}
  })
  export default class FinancialNet extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 区划下拉选的属性配置
    ...
    @financialNetModule.Action('save')
    saveData

    @financialNetModule.Action('get')
    getData

    @financialNetModule.Action('update')
    updateData
