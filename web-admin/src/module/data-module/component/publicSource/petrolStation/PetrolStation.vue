      ...
      <el-form label-width="100px"
        ...
        <el-tabs>
          <el-tab-pane label="基本信息">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="营业时间" prop="businessHours">
                  <el-input v-model="data.businessHours" :disabled="readonly" maxlength="100"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="收费方式" prop="wayToCharge">
                  <el-input v-model="data.wayToCharge" :disabled="readonly" maxlength="50"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="所属公司" prop="theCompanyOfAffiliation">
                  <el-input v-model="data.theCompanyOfAffiliation" :disabled="readonly" maxlength="100"/>
                </el-form-item>
              </el-col>
            </el-row>
...
<script>
  ...
  const petrolStationModule = namespace('data/petrolStation')
  ...
  export default class PetrolStation extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 区划下拉选的属性配置
    ...
    @petrolStationModule.Action('save')
    saveData

    @petrolStationModule.Action('get')
    getData

    @petrolStationModule.Action('update')
    updateData
