  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="所属区域" prop="area" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    @petrolStationModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'petrolStation', params })
    }

    add () {
      this.$router.push({ name: 'petrolStation', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
