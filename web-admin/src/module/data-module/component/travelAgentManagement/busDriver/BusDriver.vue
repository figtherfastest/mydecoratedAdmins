            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="驾龄" prop="beenDriving">
                  <el-input v-model="data.beenDriving" :disabled="readonly"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
...
<script>
  ...
  export default class BusDriver extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 服务镜
    ...
    @busDriverModule.Action('save')
    saveData

    @busDriverModule.Action('get')
    getData

    @busDriverModule.Action('update')
    updateData
