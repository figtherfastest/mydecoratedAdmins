        ...
        <el-tabs>
          ...
          <el-tab-pane label="领队详细情况">
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="导游证发证日期" label-width="140px" prop="turnedTheReleaseDate">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="资格证发证日期" label-width="140px" prop="certificateIssuanceDate">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="领队资格证号" prop="theManagerQualificationsCardNumber">
                  <el-input v-model="data.theManagerQualificationsCardNumber" :disabled="readonly"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="领队证发证日期" label-width="140px" prop="leaderCardIssuanceDate">
                  <el-input v-model="data.leaderCardIssuanceDate" :disabled="readonly"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
...
<script>
  ...
  const leaderCharacterModule = namespace('data/leaderCharacter')
  const regionModule = namespace('data/region')
  @Component({
    components: {}
  })
  export default class LeaderCharacter extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 标准合格率
        theManagerQualificationsCardNumber: [{
          validator: myrules.validatLength,
          maxlength: 200,
          msg: '长度不能超过200',
          trigger: 'blur'
        }],
// leadercardissuancedate
        leaderCardIssuanceDate: [{
          validator: myrules.validatLength,
          maxlength: 200,
          msg: '长度不能超过200',
...
// 附属单位类型
    ...
    @leaderCharacterModule.Action('save')
    saveData

    @leaderCharacterModule.Action('get')
    getData

    @leaderCharacterModule.Action('update')
    updateData
