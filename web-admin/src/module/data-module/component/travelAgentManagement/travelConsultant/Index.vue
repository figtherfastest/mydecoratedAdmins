...
<script>
  ...
  const travelConsultantModule = namespace('data/travelConsultant')
  ...
  export default class Index extends Vue {
    ...
    @travelConsultantModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'travelConsultant', params })
    }

    add () {
      this.$router.push({ name: 'travelConsultant', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
