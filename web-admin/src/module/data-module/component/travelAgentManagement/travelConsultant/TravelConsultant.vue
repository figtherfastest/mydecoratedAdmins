...
<script>
  ...
  export default class TravelConsultant extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 家庭住址
    ...
    @travelConsultantModule.Action('save')
    saveData

    @travelConsultantModule.Action('get')
    getData

    @travelConsultantModule.Action('update')
    updateData
