    ...
    <el-main>
      <el-form label-width="100px"
        ...
        <el-tabs>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="荣誉称号" prop="titleOfHonor">
                  <el-input v-model="data.titleOfHonor" :disabled="readonly" maxlength="150"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="交通描述" prop="trafficDescription">
                  <el-input v-model="data.trafficDescription" :disabled="readonly" maxlength="50"/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-tab-pane>

          <el-tab-pane label="是服务信息">
            <el-row>
              <el-col :span="12">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="救援电话" prop="rescueTheTelephone">
                  <el-input v-model="data.rescueTheTelephone" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="开放时间" prop="openTime">
                  <el-input v-model="data.openTime" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="最大承载量" prop="largestCapacity">
                  <el-input v-model="data.largestCapacity" :disabled="readonly"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
          ...
          <el-tab-pane label="多媒体数据">
            <el-row>
              <el-col :span="12">
                <el-form-item label="图片库" prop="theGallery">
                  <el-input v-model="data.theGallery" :disabled="readonly"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="视频库" prop="videoLibrary">
                  <el-input v-model="data.videoLibrary" :disabled="readonly"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="音频库" prop="audioLibrary">
                  <el-input v-model="data.audioLibrary" :disabled="readonly"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="虚拟素材库" prop="virtualMaterialLibrary">
                  <el-input v-model="data.virtualMaterialLibrary" :disabled="readonly"/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-tab-pane>
...
<script>
  ...
  export default class EmergingFormats extends Vue {
    @Prop({ default: () => 'new' })
    id
    ...
    @emergingFormatsModule.Action('save')
    saveData

    @emergingFormatsModule.Action('get')
    getData

    @emergingFormatsModule.Action('update')
    updateData
    // 区划下拉选的属性配置
    areaProps = {
      children: 'children',
