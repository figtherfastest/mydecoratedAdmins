  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="场馆类型" prop="venueType" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    @scienceAndTechnologyCultureCenterModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'scienceAndTechnologyCultureCenter', params })
    }

    add () {
      this.$router.push({ name: 'scienceAndTechnologyCultureCenter', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
