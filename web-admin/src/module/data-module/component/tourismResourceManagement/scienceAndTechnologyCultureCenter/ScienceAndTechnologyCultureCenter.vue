            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="占地面积" prop="coversOfArea">
                  <el-input v-model="data.coversOfArea" :disabled="readonly" maxlength="50"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="场馆类型" prop="venueType">
                  <!--<el-input v-model="data.venueType" :disabled="readonly"/>-->
                  <el-select v-model="data.venueType" placeholder="场馆类型">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="预订电话" prop="reservationPhone">
                  <el-input v-model="data.reservationPhone" :disabled="readonly" maxlength="200"/>
                </el-form-item>
              </el-col>
            </el-row>
...
<script>
  ...
  const scienceAndTechnologyCultureCenterModule = namespace('data/scienceAndTechnologyCultureCenter')
  ...
  export default class ScienceAndTechnologyCultureCenter extends Vue {
    @Prop({ default: () => 'new' })
    id
    ...
    @scienceAndTechnologyCultureCenterModule.Action('save')
    saveData

    @scienceAndTechnologyCultureCenterModule.Action('get')
    getData

    @scienceAndTechnologyCultureCenterModule.Action('update')
    updateData
    // 区划下拉选的属性配置
    areaProps = {
      children: 'children',
