  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="景区等级" prop="areaLevel" sortable="custom"/>
        <el-table-column label="景区类型" prop="scenicSpotType" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    regions
    @touristAttractionsModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'touristAttraction', params })
    }

    add () {
      this.$router.push({ name: 'touristAttraction', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
