      ...
      <el-form label-width="100px"
        ...
        <el-tabs>
          <el-tab-pane label="基本信息">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="客运站Logo" prop="logo">
          ...
          <el-tab-pane label="大巴车次信息" v-if="id!=='new'">
            <big-buses :station-id="id"/>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-main>
...
<script>
  ...
  export default class PassengerStation extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 计时器音数
    ...
    @passengerStationModule.Action('save')
    saveData

    @passengerStationModule.Action('get')
    getData

    @passengerStationModule.Action('update')
    updateData
