  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="所在区域" prop="areaName"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    regions
    @railwayStationModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'railwayStation', params })
    }

    add () {
      this.$router.push({ name: 'railwayStation', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
