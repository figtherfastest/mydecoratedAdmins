...
<script>
  ...
  const carModule = namespace('data/car')
  ...
  export default class Index extends Vue {
    ...
    get serverParams () {
      return { ...this.searchObj, companyId: this.companyId }
    }
    ...
    edit ({ id }) {
      this.$router.push({ name: 'car', params: { id, companyId: this.companyId } })
    }

    add () {
      this.$router.push({ name: 'car', params: { id: 'new', companyId: this.companyId } })
    }
  }
</script>
<style lang="less">
