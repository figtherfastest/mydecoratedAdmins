    ...
    <el-main>
      <el-form label-width="100px"
        ...
        <el-tabs>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="微信公众账号二维码" label-width="140px" prop="weChatPublicAccountQrCode">
                  <!--<el-input v-model="data.weChatPublicAccountQrCode" :disabled="readonly"/>-->
          ...
          <el-tab-pane label="车辆信息" v-if="id!=='new'">
            <cars :company-id="id"/>
          </el-tab-pane>
        </el-tabs>
      </el-form>
...
<script>
  ...
  export default class CarRental extends Vue {
    @Prop({default: () => 'new'})
    id
...
// 支付方式
    ...
    @carRentalModule.Action('save')
    saveData

    @carRentalModule.Action('get')
    getData

    @carRentalModule.Action('update')
    updateData
