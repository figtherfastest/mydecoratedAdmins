  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="客车级别" prop="level" sortable="custom"/>
        <el-table-column label="客车类型" prop="carType" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    regions
    @tourBusModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'tourBus', params })
    }

    add () {
      this.$router.push({ name: 'tourBus', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
