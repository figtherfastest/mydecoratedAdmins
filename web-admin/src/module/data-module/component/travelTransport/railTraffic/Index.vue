  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="首末班车时间" prop="firstClosingTime" sortable="custom"/>
...
<script>
  ...
  export default class Index extends Vue {
    ...
    regions
    @railTrafficModule.State('url')
    ajax

    edit (params) {
      this.$router.push({name: 'railTraffic', params})
    }

    add () {
      this.$router.push({name: 'railTraffic', params: {id: 'new'}})
    }
  }
</script>
<style lang="less">
