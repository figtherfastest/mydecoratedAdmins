      ...
      <el-form label-width="100px"
        ...
        <el-tabs>
          <el-tab-pane label="基本信息">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="等级" prop="type">
                  <el-select v-model="data.type" placeholder="请选择" :disabled="readonly">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="轨道交通Logo" label-width="140px" prop="logo">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="换乘说明" prop="transferInstruction">
                  <el-input v-model="data.transferInstruction" :disabled="readonly"/>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="出口说明" prop="exitIntroduction">
                  <el-input v-model="data.exitIntroduction" :disabled="readonly"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
          ...
          <el-tab-pane label="轨道交通线路信息" v-if="id!=='new'">
            <rail-transits :traffic-id="id"/>
            <!--<el-row>-->
            <!--<el-col :span="12">-->
            <!--<el-form-item label="轨道交通线路信息" prop="railTransitLineInformation">-->
            <!--<el-input v-model="data.railTransitLineInformation" :disabled="readonly"/>-->
            <!--</el-form-item>-->
            <!--</el-col>-->
            <!--</el-row>-->
          </el-tab-pane>
...
<script>
  ...
  import RailTransits from './RailTransits'
  import * as myrules from '../../../commonjs/rule'

  const railTrafficModule = namespace('data/railTraffic')
  ...
  export default class RailTraffic extends Vue {
    @Prop({ default: () => 'new' })
    id
...
// 抱怨次数
    ...
    @railTrafficModule.Action('save')
    saveData

    @railTrafficModule.Action('get')
    getData

    @railTrafficModule.Action('update')
    updateData
