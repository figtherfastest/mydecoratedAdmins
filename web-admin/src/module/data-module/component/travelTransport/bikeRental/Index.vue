  ...
  <el-container>
    <el-main>
      ...
      <ele-data-tables :server-params="searchObj"
        ...
        <el-table-column label="性质" prop="nature" sortable="custom"/>
...
<script>
  ...
  const bikeRentalModule = namespace('data/bikeRental')
  ...
  export default class Index extends Vue {
    ...
    regions
    @bikeRentalModule.State('url')
    ajax

    edit (params) {
      this.$router.push({ name: 'bikeRental', params })
    }

    add () {
      this.$router.push({ name: 'bikeRental', params: { id: 'new' } })
    }
  }
</script>
<style lang="less">
