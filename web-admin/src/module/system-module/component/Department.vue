<template>
  <el-form :model="department" label-width="100px">
    ...
    <el-form-item label="部门名称：">
      <el-input size="mini" v-model="department.fullname"/>
    </el-form-item>
    <el-form-item label="部门简称：">
      <el-input size="mini" v-model="department.shortname"/>
    </el-form-item>
    <el-form-item label="部门类型：">
      <el-select v-model="department.type" size="mini" placeholder="请选择">
