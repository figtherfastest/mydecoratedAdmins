<template>
  <el-container class="menus">
    ...
    <el-main>
      <el-form :inline="true" :model="search" class="clear-float">
        <el-row>
          <el-col :span="12">
            <el-form-item class="pull-left">
              <el-input size="mini" placeholder="请输入关键字" v-model="search.search"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
      ...
      <ele-data-tables :ajax="ajax"
        ...
        <el-table-column prop="id" label="操作" :min-width="120">
          <span slot-scope="scope">
            ...
            <el-button type="text" size="mini" @click="move({id:scope.row.id,position:'UP'})">上移</el-button>
            <el-button type="text" size="mini" @click="move({id:scope.row.id,position:'DOWN'})">下移</el-button>
