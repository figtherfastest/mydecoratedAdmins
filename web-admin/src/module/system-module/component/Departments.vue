<template>
  <el-container>
    ...
    <el-main>
      <el-form :model="search" :inline="true" class="clear-float">
        <div class="pull-left">
          <el-form-item>
        ...
        <div class="pull-right">
          <el-form-item>
            <el-input v-model="search.search" size="mini" placeholder="输入关键字查询"/>
          </el-form-item>
        </div>
      </el-form>
      <ele-data-tables :ajax="tableUrl"
        ...
        <el-table-column prop="id" label="操作">
          <span slot-scope="scope">
            <el-button type="text" size="mini" @click="toggleState(scope.row)">{{ scope.row.state === 'ENABLED' ? '禁用' : '启用' }}</el-button>
            <el-button type="text" size="mini" @click="edit(scope.row.id)">编辑</el-button>
            <el-button type="text" size="mini" @click="up(scope.row.id)">上移</el-button>
            <el-button type="text" size="mini" @click="down(scope.row.id)">下移</el-button>
          </span>
        </el-table-column>
      </ele-data-tables>
    </el-main>
